      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--starland-muted-text)]">
            Inspect the exact employee-type database
            structure before enabling creation,
            editing, duplicate prevention, status
            controls, attendance-policy relationships,
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h2 className="mt-4 text-2xl font-extrabold tracking-tight">
                Exact Employee Type Schema Discovery
              </h2>

              <p className="mt-2 max-w-4xl text-sm leading-6 text-white/70">
                The application reads the current
                MySQL metadata so the upcoming
                employee-type CRUD matches the real
                identifier, code, name, status,
                timestamps, unique constraints, and
