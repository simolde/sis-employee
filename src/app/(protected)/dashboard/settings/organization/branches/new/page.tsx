...
import { createBranchAction } from "@/features/settings/organization/branches/server/branch-management-actions";
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--starland-muted-text)]">
            Add a new school branch and optionally
            configure its attendance geofence.
          </p>
        </div>
      ...
      <section className="starland-card overflow-hidden">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-2 max-w-4xl text-sm leading-6 text-white/70">
                ...
                Geofence coordinates can be added now
                or configured later.
              </p>
            </div>
          </div>
        ...
        <div className="flex items-start gap-3 bg-[var(--starland-modern-bg)] p-4">
          ...
          <p className="text-sm font-semibold leading-6 text-[var(--starland-muted-text)]">
            Active branches can be assigned to
            employees and attendance punches.
          </p>
        </div>
      </section>
