...
import { createDesignationAction } from "@/features/settings/organization/designations/server/designation-management-actions";
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--starland-muted-text)]">
            Add a new employee job title or position
            that can be assigned to employee
            profiles.
          </p>
        </div>
      ...
      <section className="starland-card overflow-hidden">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h2 className="mt-4 text-2xl font-extrabold tracking-tight">
                Job Title and Position Identity
              </h2>

              <p className="mt-2 max-w-4xl text-sm leading-6 text-white/70">
                Use a short, stable designation code
                and the complete job title.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3 bg-[var(--starland-modern-bg)] p-4">
          ...
          <p className="text-sm font-semibold leading-6 text-[var(--starland-muted-text)]">
            Active designations can be selected when
            creating or updating employee profiles.
          </p>
        </div>
      </section>
