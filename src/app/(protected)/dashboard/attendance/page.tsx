...
const attendanceNavigationCards: AttendanceNavigationCard[] =
  [
    ...
    },
    {
      ...
      description:
        "Review automatic EXCUSED generation and reconciliation rollback activity with complete audit values.",
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--starland-muted-text)]">
            Review employee attendance from ODL web
            attendance, RFID, biometric kiosks,
            approved-leave automation, manual
            corrections, and future synchronized
            attendance sources.
          </p>
        </div>
