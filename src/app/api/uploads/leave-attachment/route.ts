...
import type { LeaveAttachmentUploadResponse } from "@/features/leaves/types/leave-upload-types";
...
function jsonResponse(body: LeaveAttachmentUploadResponse, status: number) {
