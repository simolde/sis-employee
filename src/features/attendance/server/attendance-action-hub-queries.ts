...
export async function getAttendanceActionHubStats(): Promise<AttendanceActionHubStats> {
  ...
  const [
    ...
    getExcusedReconciliationOverviewStats(),
  ]);
  ...
  return {
    ...
    excusedAutomaticChecked:
      excusedReconciliationStats.automaticExcusedChecked,

    excusedProtectedByApprovedLeave:
      excusedReconciliationStats.protectedByApprovedLeave,

    excusedReconciliationEligible:
      excusedReconciliationStats.rollbackEligible,
