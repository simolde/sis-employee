...
import {
  buildBranchSchemaCopyReport,
} from "../server/branch-schema-queries";
import type {
  BranchSchemaInspectionData,
} from "../types/branch-schema-types";
import { BranchSchemaCopyButton } from "./branch-schema-copy-button";

type BranchSchemaDashboardProps = {
  data:
    BranchSchemaInspectionData;
};
...
function statusContainerClass(
  status:
    BranchSchemaInspectionData["status"],
): string {
  switch (status) {
    case "READY":
...
export function BranchSchemaDashboard({
  data,
}: BranchSchemaDashboardProps) {
  const copyReport =
    buildBranchSchemaCopyReport(
      data,
    );
            ...
            <tbody>
              ...
              0 ? (
                ...
                <tr>
                  ...
                  >
                    <div className="p-6 text-center text-sm text-[var(--starland-muted-text)]">
                      The branches table contains no
                      records.
                    </div>
                  </td>
                </tr>
