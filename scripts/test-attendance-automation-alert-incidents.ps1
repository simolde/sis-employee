...
.\scripts\test-attendance-automation-alert-incidents.ps1 -Secret "your-secret"
"@
}
...
Write-Host ""
Write-Host `
    "Attendance automation alert incident history" `
...
switch ($statusCode) {
    200 {
        Write-Host (
            "Automation alert incident history was retrieved."
    ...
    default {
        Write-Host (
            "The incident history request failed."
        ) -ForegroundColor Red
