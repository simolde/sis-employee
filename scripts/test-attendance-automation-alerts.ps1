...
.\scripts\test-attendance-automation-alerts.ps1 -Secret "your-secret"
"@
}
...
Write-Host ""
Write-Host "Attendance automation alerts check" `
...
switch ($statusCode) {
    200 {
        Write-Host (
            "No critical automation alerts are active."
    ...
    503 {
        Write-Host (
            "One or more critical automation alerts require attention."
    ...
    default {
        Write-Host (
            "The automation alert request failed."
        ) -ForegroundColor Red
